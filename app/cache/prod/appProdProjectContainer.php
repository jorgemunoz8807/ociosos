...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/ociosos/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/ociosos/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/xampp/htdocs/ociosos/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/ociosos/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'ociosos', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_0b7ea2905c8c334a3198b040659e40a6');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0b7ea2905c8c334a3198b040659e40a6');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_0b7ea2905c8c334a3198b040659e40a6');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\ComunBundle\\Entity', 1 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\UsuarioBundle\\Entity', 2 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Entity'));
        ...
        $g->setProxyDir('C:/xampp/htdocs/ociosos/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/ociosos/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/ociosos/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/ociosos/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/ociosos/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/ociosos/app/cache/prod/sessions');
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), 1.3000000000000000444089209850062616169452667236328125, '%s?%s'), array());
    }
    protected function getTemplating_Helper_CodeService()
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/ociosos/app', 'UTF-8');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\ComunBundle/Resources/views', 'Comun');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\AdminBundle/Resources/views', 'Admin');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\EditorBundle/Resources/views', 'Editor');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\UsuarioBundle/Resources/views', 'Usuario');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\RodasXMLBundle/Resources/views', 'RodasXML');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\ReporteBundle/Resources/views', 'Reporte');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\knplabs\\knp-paginator-bundle\\Knp\\Bundle\\PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('C:/xampp/htdocs/ociosos/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/ociosos/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/ociosos/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\AdminBundle\\Resources\\config\\validation.yml', 1 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\UsuarioBundle\\Resources\\config\\validation.yml', 2 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/ociosos/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/ociosos/app/cache/prod',
            'kernel.logs_dir' => 'C:/xampp/htdocs/ociosos/app/logs',
            ...
            'session.save_path' => 'C:/xampp/htdocs/ociosos/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\AdminBundle\\Resources\\config\\validation.yml',
                1 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\UsuarioBundle\\Resources\\config\\validation.yml',
                2 => 'C:\\xampp\\htdocs\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'router.resource' => 'C:/xampp/htdocs/ociosos/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/ociosos/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/ociosos/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/ociosos/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/ociosos/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/ociosos/app/cache/prod/doctrine/orm/Proxies',
