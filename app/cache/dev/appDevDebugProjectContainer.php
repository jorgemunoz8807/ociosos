...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/ociosos/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/ociosos/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/ociosos/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/ociosos/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return ComunBundle\Captcha A ComunBundle\Captcha instance.
     */
    protected function getCaptchaService()
    {
        return $this->services['captcha'] = new \ComunBundle\Captcha('request');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'ociosos', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_0012f12a4e965d33f86ffb83f225b8dc');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0012f12a4e965d33f86ffb83f225b8dc');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_0012f12a4e965d33f86ffb83f225b8dc');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\ComunBundle\\Entity', 1 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\UsuarioBundle\\Entity', 2 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Ociosos\\ComunBundle\\Entity');
        $f->addDriver($e, 'Ociosos\\UsuarioBundle\\Entity');
        $f->addDriver($e, 'Ociosos\\RodasXMLBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('ComunBundle' => 'Ociosos\\ComunBundle\\Entity', 'UsuarioBundle' => 'Ociosos\\UsuarioBundle\\Entity', 'RodasXMLBundle' => 'Ociosos\\RodasXMLBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/wamp/www/ociosos/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/ociosos/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '77ed0710217e3ffb3a3d2d28890ad37efe01f02e');
    }
    ...
    {
        $this->services['locale_listener'] = $instance = new \Symfony\Component\HttpKernel\EventListener\LocaleListener('sp', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/ociosos/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/ociosos/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/ociosos/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/ociosos/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Ociosos\\UsuarioBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'Symfony\\Component\\Se3curity\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'PlainText', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/ociosos/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/ociosos/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/wamp/www/ociosos/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/ociosos/app/cache/dev/sessions');
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), 1.3, '%s?%s'), array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/ociosos/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', '/usuario/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/wamp/www/ociosos/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/ociosos/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/ociosos/app', 'UTF-8'));
        ...
        $instance->addGlobal('roles', array('ROLE_ADMIN' => 'Administrador', 'ROLE_EDITOR' => 'Editor', 'ROLE_VIEWER' => 'Consultante'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\ComunBundle/Resources/views', 'Comun');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\AdminBundle/Resources/views', 'Admin');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\EditorBundle/Resources/views', 'Editor');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\UsuarioBundle/Resources/views', 'Usuario');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\RodasXMLBundle/Resources/views', 'RodasXML');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Ociosos\\ReporteBundle/Resources/views', 'Reporte');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\knplabs\\knp-paginator-bundle\\Knp\\Bundle\\PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('C:\\wamp\\www\\ociosos\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/ociosos/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('77ed0710217e3ffb3a3d2d28890ad37efe01f02e');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/ociosos/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/ociosos/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter(new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_EDITOR' => array(0 => 'ROLE_VIEWER'), 'ROLE_ADMIN' => array(0 => 'ROLE_VIEWER', 1 => 'ROLE_EDITOR')))), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($this->get('security.authentication.trust_resolver'))), 'affirmative', false, true);
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Ociosos\\UsuarioBundle\\Entity\\Usuario', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/ociosos/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\AdminBundle\\Resources\\config\\validation.yml', 1 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\UsuarioBundle\\Resources\\config\\validation.yml', 2 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/ociosos/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/ociosos/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/ociosos/app/logs',
            'kernel.bundles' => array(
                ...
                'ComunBundle' => 'Ociosos\\ComunBundle\\ComunBundle',
                'AdminBundle' => 'Ociosos\\AdminBundle\\AdminBundle',
                'EditorBundle' => 'Ociosos\\EditorBundle\\EditorBundle',
                'UsuarioBundle' => 'Ociosos\\UsuarioBundle\\UsuarioBundle',
                'RodasXMLBundle' => 'Ociosos\\RodasXMLBundle\\RodasXMLBundle',
                'ReporteBundle' => 'Ociosos\\ReporteBundle\\ReporteBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'ociosos',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.citmatel.inf.cu',
            'mailer_user' => 'ntcedisac\\dany',
            'mailer_password' => 'Stern0123',
            'locale' => 'sp',
            'secret' => '77ed0710217e3ffb3a3d2d28890ad37efe01f02e',
            ...
            'debug.container.dump' => 'C:/wamp/www/ociosos/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '77ed0710217e3ffb3a3d2d28890ad37efe01f02e',
            ...
            'session.save_path' => 'C:/wamp/www/ociosos/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\ociosos\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\AdminBundle\\Resources\\config\\validation.yml',
                1 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\UsuarioBundle\\Resources\\config\\validation.yml',
                2 => 'C:\\wamp\\www\\ociosos\\src\\Ociosos\\RodasXMLBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/ociosos/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/ociosos/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/ociosos/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.citmatel.inf.cu',
            'swiftmailer.mailer.default.transport.smtp.username' => 'ntcedisac\\dany',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Stern0123',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/ociosos/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/ociosos/app/../web',
            'assetic.write_to' => 'C:/wamp/www/ociosos/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/ociosos/app/cache/dev/doctrine/orm/Proxies',
